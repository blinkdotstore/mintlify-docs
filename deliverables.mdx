...
<Accordion title="License Keys">
  Automatically generate and issue software license keys upon purchase. You can choose to set a specific expiration timeframe or make them lifetime licenses. You can also enforce activation limits and manage key validations programmatically via the API.
  
  <Note>For subscription products, license keys will automatically be revoked when the subscription ends or is canceled, regardless of their expiration setting.</Note>
</Accordion>
